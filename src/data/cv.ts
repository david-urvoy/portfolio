...
export const cv: Cv = {
    name: 'David Urvoy',
    title: 'Lead Front & React Expert (React / Next.js / Three.js)',
    location: 'Lyon',
    ...
    description:
        'Lead developer front-end (React, Three.js), je conçois des applications soignées et évolutives, en veillant à aligner excellence technique et vision produit.',
    ...
    experiences: [
        {
            ...
            description:
                'Lead dev Front pour la refonte du site e-commerce multi-marques (Prolians, Hydralians, Dexis).',
            details: `
...
Organisation technique de la squad (backlog, rétrospectives, accompagnement développeurs).
      `,
        ...
        },
        {
            ...
            description:
                "Développement fullstack de l'application Matrix pour configuration et versioning des machines Carrier.",
            details: `
...
Backend CRUD généré via Prisma et servi par Apollo GraphQL. Hébergé sur AWS (Lambdas, CloudFront, RDS).
      `,
        ...
        },
        {
            ...
            description:
                "Développement de microservices pour une plateforme d'analyse sémantique.",
            details: `
...
Cloud GCP, Kubernetes, front React/Redux, services REST Kotlin/Spring.
      `,
        ...
        },
        {
            ...
            description:
                'Développement d’un site web et divers outils informatiques pour une association.',
            details: `
...
TDD, BDD (Cucumber), tests unitaires et acceptance, accompagnement de 5 devs.
      `,
        ...
        },
        {
            ...
            description:
                "Développement d'une application microservices pour la gestion de sinistres.",
            stack: [
                'Angular 7',
                'TypeScript',
                'Java 8',
        ...
        },
        {
            ...
            description:
                'Supervision de compteurs intelligents destinés aux professionnels.',
            stack: [
                'Javascript',
                'AngularJS',
                'Java 8',
    ...
    projects: [
        ...
        },
        {
            ...
            description:
                "Démo des bases de Docker : containerisation d'une app React/Kotlin/MySQL et exploitation multi-instances.",
        },
    ],
